...
with tf.name_scope("middle_network"):
    middle_net = Dense(10000, activation='relu')(input_net)
    #middle_net = Dropout(0.5)(middle_net)
   # middle_net = Dense(50, activation='relu')(middle_net)
    middle_net = Dropout(0.5)(middle_net)
    #iddle_net = Dense(100, activation='relu')(middle_net)
...
summary_writer = tf.summary.FileWriter('/tansfer.keras/logs1/role1')
summary_writer.add_graph(session.graph)


#optimize(2000, role_networks[1:], None)
optimize(2000, role_networks[:1], summary_writer)