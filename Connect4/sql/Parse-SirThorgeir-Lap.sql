select
	...
	IF(LOCATE('CELL 1 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 2 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 3 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 4 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 5 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 6 0 DIRT',state) > 0, 1, -1), 
	...
	IF(LOCATE('CELL 7 0 DIRT',state) > 0, 1, -1), 
