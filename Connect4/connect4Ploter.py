...
networks = [ 
    fully_connected_network([128,64,128,64,128,8], "A"),
    fully_connected_network([1000,250,500,250,1000,8], "B"),
    fully_connected_network([128,64,128,8], "C"),
    fully_connected_network([8], "D")
]
