...
\begin{figure}[H]
    \begin{tikzpicture}
        ...
        \iftoggle{render_graphs}{
            ...
            \errorband[green, opacity=0.5,forget plot] {data/breakthrough_long_run.csv}{0}{1}{2}
            \addplot
                +[thick, mark=*, mark options={fill=green}, mark repeat=5, mark size=2, green!50!black] 
                table [x index=0, y index=1,col sep=comma]
                {data/breakthrough_long_run.csv};
                         
            \errorband[blue, opacity=0.5,forget plot]{data/chinese_checkers_6_long_run.csv}{0}{1}{2}
            \addplot
                +[thick, mark=diamond*, mark options={fill=blue}, mark repeat=5, mark size=2.5, blue!50!black] 
                table [x index=0, y index=1,col sep=comma]
